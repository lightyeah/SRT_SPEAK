...
static void ADC1_Mode_Config(void)
{
	...
	DMA_InitStructure.DMA_MemoryInc = DMA_MemoryInc_Enable;  //内存地址buding
	...
	ADC_InitStructure.ADC_ScanConvMode = ENABLE ; 	 //焦扫描模式，扫描模式用于多通道采集
	...
	/*配置ADC时钟，为PCLK2的4分频，即18MHz*/
	RCC_ADCCLKConfig(RCC_PCLK2_Div4); 
	/*配置ADC1的通道1.0为55.	5个采样周期，序列为2,1 */ 
